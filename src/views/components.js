const components = {
    ...
    wordProductsPage: function (products, categories) {
        ...
        categories.forEach((category) => {
            const item = products.filter((product) => product.category_id === category.id);
            filterArray.push({
                                    ...
                                    ${components.managerThreat()}  
                                        ...
                                        ${domainData
                                            .map((domain, index) => {
                                                ...
                                                return components.managerTr(domain, index);
                                            })
                                            .join('')}  
                                        </tbody>    
                                    </table>
    ...
    managerTd: function (index, domain) {
        return `
                ...
                <td class='action-table'>                
                        <p class='edit-all-product-action' domain-id='${domain.id}'>Chỉnh sửa</p>
                    ...
                    <div class='news-content-wrapper'>
                            ...
                            ${[...cvData]
                                ...
                                <div news-id = ${cv.id} class='news-item ${index === 0 ? 'active' : ''}'>
                                    ...
                                    <div class='news-infor'>
                                        ...
                                        <span>${tools.handleTime(cv.created_at)}</span> 
                                    </div>
                                </div>
                                `;
                                })
                        ...
                        <div class='news-content-edit'>
                            <div class='news-content-edit-content cv-area'>
                                ${components.cvRecruitmentsDetailUI(cvData[cvDataLength - 1])}
                            </div> 
                        </div>
                    </div>
                </div>
    ...
    cvRecruitmentsDetailUI: function (cv) {
        ...
        <div class='person-infor'>
            ...
            <div class="update-all-value">
                <span >Ngày nộp: <b>${tools.handleTimeFull(cv.created_at)}</b></span>       
            </div>
        ...
        <div class='cv-pdf-area'> 
            <embed class='cv' src="${'https://daily.intern.midvietnam.com/' + cv.file}#scrollbar=0" />
        </div>
                    ...
                    <div class='news-content-wrapper'>
                        <div class='news-list'>
                            ${[...recruitmentsData]
                                ...
                                .map((recruitment, index) => {
                                    return `
                                <div news-id = ${recruitment.id} class='news-item ${index === 0 ? 'active' : ''}'>
                                    <div class='news-name'>${recruitment.title} </div>
                                    <div class='news-infor'>
                                        <span>${tools.handleTime(recruitment.date)} đến ${tools.handleTime(
                        ...
                        <div class='news-content-edit'>
                            <div class='news-content-edit-content'>
                                ${components.recruitmentsDetailUI(recruitmentsData[0])}
                            </div> 
                        </div>
                    </div>
                </div>
                        ...
                        <div class='news-list'>
                            ${
                                ...
                                <div news-id = ${newData.id} class='news-item ${index === 0 ? 'active' : ''}'>
                                    <div class='news-name'>${newData.title} </div>
                                </div>
                                `;
                                          })
                                          .join('')
                    ...
                    <div class='news-content-wrapper'>
                        <div class='news-list'>
                            ${[...newsData]
                                ...
                                .map((newData, index) => {
                                    return `
                                <div contact-id = ${newData.id} class='news-item contact-item-tab ${
                                        index === 0 ? 'active' : ''
                                    }'>
                                    <div class='news-name'>${newData.name} </div>
                                    <div class='news-infor'>
                                        <span>${tools.handleTime(newData.create_at)}</span>
                        ...
                        <div class='news-list'>
                            ${[...newsData]
                                ...
                                <div news-id = ${newData.id} class='news-item ${index === 0 ? 'active' : ''}'>
                                    <div class='news-name'>${newData.title} </div>
                                    <div class='news-infor'>
                                        <span>${tools.handleTime(newData.date)}</span>
                                        <span>${Number(newData.featured) ? '(Nổi bật)' : ''}</span>
                                    </div>
                                </div>
                                `;
                                })
                    ...
                    <div class='service-content-wrapper'>
                        <div class='service-list'>
                            ${serviceData
                                .map((service, index) => {
                                    return `
                                <div service-id = ${service.id} class='service-item ${index === 0 ? 'active' : ''}'>
                    ...
                    <div class="statistical-wrapper-master" style="display: none">
                        <div class="statistical-wrapper">
                            <p class="statistical-item">
                                Tổng số đơn hàng: <span>${orderData.length}</span>
                            </p>
                            <p class="statistical-item">
                                Chờ xác nhận: <span>${orderData.filter((order) => order.status === 1).length}</span>
                            </p>
                            <p class="statistical-item">
                                Đã xác nhận: <span>${orderData.filter((order) => order.status === 2).length}</span>
                            </p>
                            <p class="statistical-item">
                                Đã giao: <span>${orderData.filter((order) => order.status === 3).length}</span>
                            </p>
                            <p class="statistical-item">
                                Đã huỷ: <span>${orderData.filter((order) => order.status === 0).length}</span>
                            </p>
                        </div>
                    </div>
                </div>
                                ...
                                <table class='order-table'>
                                    ...
                                    <tbody class="product-tbody">
                                        ${orders
                                            .map((order, index) => {
                                                // components.productCard(product);
                                                return components.orderTr(order, index);
                                            })
                                            .join('')}
                                    </tbody>
                                </table>
    ...
    orderTr: function (order, index) {
        return `
            <tr data='${order.id}' class='order-tr' title="Nhấn vào để xem chi tiết">
                <td>${order.id}</td>
                <td class='product-order'>                
                    ${tools.handleProductOrder(order.products)}                       
                </td>
                <td> 
                    <p class='blue'><b>${nf.format(order.total_money)} đ </b></p>                       
                </td>
                <td>                 
                    <p>${order.fullname}</p>                       
                </td>
        ...
        <div class='action-order-ui-wrapper'>
            <div class='infor-order'>
                <div class="update-all-value order-infor-item">
                    ...
                    <div class='all-product-action-table'>${tools.handleProductOrderDetail(order.products)} </div>
                </div>
                <div class="update-all-value order-infor-item">
                    <span class='update-all-value-title order-title-all'>Giá trị đơn: </span>
                    <span class='blue'><b>${nf.format(order.total_money)} đ </b></span>
                </div>
                <div class="update-all-value order-infor-item">
                ...
                <div class="update-all-value order-infor-item">
                    ...
                    <span><b>${tools.handleTimeFull(order.order_date)}</b></span>
                </div>
                <div class="update-all-value order-infor-item">
    ...
    productsPage: function (products, category) {
        ...
        let inventoryNum = products.reduce((sum, curr) => sum + Number(curr.inventory_num), 0);
        const filterArray = [];
                                ...
                                <div class='table-wrapper'>
                                    ...
                                    ${components.threadProduct()}  
                                        ...
                                        ${products
                                            .map((product, index) => {
                                                // components.productCard(product);
                                                return components.producTr(product, index);
                                            })
                                            .join('')}  
                                        </tbody>    
                                    </table>
            ...
            <tr data='${product.id}'>
                ...
                <td>
                    <div class='product-title-table'>
                        ...
                        <div>
                            <p class='product-name-table-l1'>${product.title}</p>
            ...
            .map(
                (item) => `
                                <div class='products-title-layout '>
                                    <h2 class='category-title-product'>${item.category_name}</h2>
                                ...
                                <div class='table-wrapper'>
                                    ...
                                    ${components.threadProductbyCategory()}  
                                        ...
                                        ${item.products
                                            .map((product, index) => {
                                                // components.productCard(product);
                                                return components.producTrbyCategory(product, index);
                                            })
                                            .join('')}  
                                        </tbody>    
                                    </table>
    ...
    editAllUI: function (product, category) {
        ...
        <div class='form-infor-product'>
            ...
            <div class="update-all-value">
                ...
                <select id='edit-category-input'  tabindex="0" class='edit-category-input'>
                    ...
                    ${category
                        .map((category) => {
                            if (Number(category.id) === Number(product.category_id)) {
                                return `
        ...
        <div class='set-image-product-area-wrapper-edit-all'>
            ...
            <div class="update-all-value">
                ...
                <input disabled value='${tools.handleProductStatus(product.hidden)}' />
            </div>

            <div class="update-all-value">
                <span class='update-all-value-title'>Nổi bật </span>
                <select id='edit-featured-input'  tabindex="0" class='edit-featured-input'>
                            <option ${!Number(product.featured) ? 'selected' : ''} id="fea-all-0" value='0'>
                                <span>Không</span>
                            </option>
                            
                            <option ${Number(product.featured) ? 'selected' : ''} id="fea-all-1" value='1'>
                                <span>Có</span>
                            </option>         
                    </select>
            </div>
                ...
                <div class='set-image-product-area-edit-all'>
                    ...
                    ${multiBanner
                        ...
                        ${
                            image !== ''
                                ? `<div class='set-image-item required-image-item' style="background-image: url('${image}')">
                                ${!index ? '' : '<span class="delete-prooduct-img"><i class="close"></i></span>'}
                        </div>`
                                : ''
                        }
                        `;
                            ...
                            ${inforData.email
                                ...
                                <div class='infor-page-input-wrapper'>
                                    <input data-name='email' type="text" class='infor-page-input ${
                                        !index ? 'infor-required' : ''
                                    }' id='infor-page-email' value='${email.email}' placeholder='Nhập email'/>
                                    ${
                                        index
                                            ? "<div class='delete-infor-item-btn'>Xoá</div>"
                        ...
                        <div class='infor-page-inner-wrapper'>
                            ...
                            ${inforData.address
                                ...
                                <input data-name='address' type="text" class='infor-page-input ${
                                    !index ? 'infor-required' : ''
                                }' id='infor-page-address' value='${address.location}' placeholder='Nhập địa chỉ'/>
                                    ${
                                        index
                                            ? "<div class='delete-infor-item-btn'>Xoá</div>"
    ...
    mainUI: function (permission_id) {
        ...
        logoWrapper.querySelector('h2').innerText = tools.handlePermission(Number(permission_id));
        const MANAGER = -1;
        const ADMIN = 1;
        const ACCOUNTANT = 2;
        const DESIGN = 3;
        return `
                    ${
                        [MANAGER, ADMIN, ACCOUNTANT].includes(Number(permission_id))
